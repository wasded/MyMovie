...
// Сделал так потому что жанр фильма приходит как [ID], тебе необходимо делать еще один запрос на сервер, этоу получение жанра, а потом в ответе название жанра
